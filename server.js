...
const allowedOrigins = [
  'http://localhost:3000',
  'http://127.0.0.1:3000',
  'https://westend-hijama-website-f35f7.web.app',
  'https://westend-hijama-website-f35f7.firebaseapp.com',
  'https://westendhijamaclinic.co.uk',
  'https://www.westendhijamaclinic.co.uk'
];

// Add Railway URL dynamically if available
...
app.use(cors({
  origin: function (origin, callback) {
    ...
    if (allowedOrigins.indexOf(origin) !== -1) {
      ...
      // In production or development, allow all origins for now
      // This ensures Railway backend works with localhost during development
      callback(null, true);
    }
  },
  credentials: true,
...
// In production, serve static files from dist folder (if needed)
// Note: Backend only - frontend is hosted separately on Firebase
// if (isProduction && existsSync(join(__dirname, 'dist'))) {
...
app.listen(PORT, '0.0.0.0', () => {
  ...
  console.log(`📍 API endpoint: http://0.0.0.0:${PORT}/api/create-payment-intent`);
